...
<!-- Routes vulnerability reports to GitHub private vulnerability reporting instead of public issues. -->

## Supported versions

Only the most recent release published from `main` (the `latest` GHCR images) receives security fixes.
