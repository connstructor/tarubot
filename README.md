...
- **Member status posts** (2.27.0): about 2 minutes after a change, one "Member status changes" post in the officer notifications channel names the members who gained or lost Member, Guest, Officer or FC Leader, with the reason, and the linked characters that left the FC. Nothing to set up beyond that channel. See [OPERATIONS.md](docs/OPERATIONS.md#status-notices).
