...
| `cooldown`, `rate_limited`, `busy`, `transient`, `stopping` | Please wait a moment, and the claim, application and report limits | A limit, contention, a temporary Discord change or a shutdown | None; the reply says when to try again. |
