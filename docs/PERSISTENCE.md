...
The current **2.15.0** source requires `SCHEMA_VERSION=006_guest_application_switch.sql`, introduced in **2.15.0**. It is additive and needs no superuser privileges:
