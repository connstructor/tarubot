...
1. Read [../AGENTS.md](../AGENTS.md) and [../CLAUDE.md](../CLAUDE.md), inspect `git status`/history, and fetch remote state. Check whether 2.29.2 (`chore/generic-host-2.29.2`) was pushed and merged; 2.29.1 merged as PR #40 (`be733ba`).
