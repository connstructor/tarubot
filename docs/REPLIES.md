...
| `presenters/<group>.ts` | `characters`, `ledger`, `configuration`, `guests`, `synchronization`, `utility`, `version`, `changelog` (the update post, 2.25.0), `officer` (the status post, 2.27.0) |
