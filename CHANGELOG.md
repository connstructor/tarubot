...
- **Member note** (CLAUDE.md step 2, after merging 2.25.0): `src/domain/release-notes.ts` gains 2.26.0's note, "Members and guests can now suggest TaruBot features with /suggest: the idea is posted publicly on GitHub by TaruBot, without your name." A server with a changelog channel gets it in one update post when it starts on 2.26.0.
