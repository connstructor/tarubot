import { routineLog } from "../domain/reports.js";

/**
 * The last log records, kept in memory for issue reports (2.18.0). The composition root adds this as
 * a second pino destination at info and above, so it holds what the container log shows, after
 * pino's own redaction, minus routine periodic records (2.18.1). A report includes the newest
 * records, redacted again, as context for what the bot was doing just before the trouble.
 */
